    ...
    <div className="relative z-10 mx-auto max-w-7xl px-6">
      <div className="grid md:grid-cols-12 gap-8 items-end">
        ...
        <div className="md:col-span-5 flex flex-col gap-6 border-b-[6px] border-black pb-4">
           ...
           <div className="flex gap-4">
             <a href="https://github.com/HEMANTHSV31" target="_blank" className="p-2 border-2 border-black text-black/70 hover:bg-black hover:text-white transition-all">
               <Github size={20} />
             </a>
             <a href="https://www.linkedin.com/in/hemanth-s-v" target="_blank" className="p-2 border-2 border-black text-black/70 hover:bg-black hover:text-white transition-all">
               <Linkedin size={20} />
             </a>
           </div>
        </div>
      ...
      <div className="mt-20 flex flex-col md:flex-row justify-between items-center gap-12">
        <div className="flex flex-col gap-1">
          ...
          <a href="mailto:svhemanth747@gmail.com" className="text-2xl md:text-4xl font-bebas text-black hover:italic transition-all">
      ...
      <div className="mt-24 pt-4 border-t-2 border-black flex justify-between items-center text-[10px] font-black uppercase tracking-[0.2em] text-black/70">
        ...
        <span className="text-black">© 2026 Hemanth</span>
        <div className="flex gap-4">
        </div>
      </div>
    </div>
