      ...
      <nav className="mx-auto w-full max-w-[90%] px-6 py-2 flex items-center justify-between">
        ...
        >
          <div className="flex items-center gap-1">
            <span className="text-black text-5xl group-hover:italic transition-all italic uppercase">
              HEMANTH{" "}
            </span>
          ...
          >
            ...
            <div className="mt-12 space-y-5 relative z-10 border-t border-white/20 pt-8">
              ...
              <div className="flex mt-4 gap-8 font-bold uppercase tracking-widest text-xs">
                <a href="https://www.linkedin.com/in/hemanth-s-v" className="hover:line-through">
                  LinkedIn
                </a>
                <a href="https://github.com/HEMANTHSV31" className="hover:line-through">
                  GitHub
                </a>
              </div>
            </div>
