...
import { Database, Zap, Search, LucideIcon, FileText } from "lucide-react";
...
const COMMITMENTS: Commitment[] = [
  {
    ...
    standard: "I architect scalable cloud infrastructures designed to eliminate single points of failure.",
    outcome: "Highly available backend environments capable of processing massive data throughput without latency.",
    icon: Database,
  },
  {
    title: "AI & RAG PIPELINES",
    standard: "I engineer retrieval-augmented reasoning workflows backed by real-time vector search.",
    outcome: "Production-ready intelligent systems that ground LLM outputs in verified enterprise data.",
    icon: Search,
  },
  {
    title: "ROBUST AUTOMATION",
    standard: "I build event-driven architectures to automate complex backend logic and data pipelines.",
    outcome: "Seamless, self-healing background processes that run 24/7 with zero manual overhead.",
    icon: Zap,
  },
];
...
export default function CallToAction() {
  return (
    <section className="relative w-full max-w-[90%] mx-auto px-4 sm:px-6 py-7 md:py-10 bg-stone-950 font-inter overflow-hidden">
      ...
      <div className="mb-8 border-b border-stone-800 pb-6 relative">
        <div className="flex items-center gap-3 mb-4 md:mb-6">
           ...
           <span className="text-[9px] md:text-[10px] font-black tracking-[0.3em] md:tracking-[0.5em] text-stone-500 uppercase">
             HEMANTH // Technical_Standards // 2026
           </span>
        </div>
      ...
      <div className="mt-8 flex flex-col md:grid md:grid-cols-2 items-start md:items-center gap-10 md:gap-16 border-t border-stone-800 pt-8">
        <div>
           <p className="text-stone-500 text-[10px] md:text-xs font-bold uppercase leading-relaxed tracking-widest max-w-sm">
             These standards ensure that every system I build remains 
             resilient, auditable, and truly autonomous.
           </p>
        </div>
