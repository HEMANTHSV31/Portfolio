...
const SKILL_GROUPS: SkillGroup[] = [
  {
    ...
    skills: ["React", "Next.js", "React Native", "Zustand", "TypeScript", "Tailwind CSS"],
  },
  {
    title: "Backend",
    description: "Designing backend systems that are predictable, debuggable, and easy to extend.",
    skills: ["Node.js", "FastAPI", "PostgreSQL", "Redis", "Kafka", "RabbitMQ"],
  },
  {
    title: "API Design // LLD & HLD",
    description: "Structuring scalable architectures, focusing on High-Level and Low-Level Design patterns.",
    skills: ["REST APIs", "Microservices", "System Architecture", "Design Patterns"],
  },
  {
    title: "Generative AI",
    description: "Building intelligent applications using large language models, retrieval-augmented generation, and agentic workflows.",
    skills: ["LLMs", "LangChain", "RAG", "Vector DBs", "Prompt Engineering"],
  },
  {
  ...
  return (
    <main className="min-h-screen bg-white text-black px-4 sm:px-6 py-12 font-inter selection:bg-black selection:text-white overflow-x-hidden">
      ...
      <motion.section
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
        className="relative z-10 mx-auto w-full max-w-[90%]"
      >
          ...
          <div className="md:col-span-8 space-y-4 md:space-y-6">
            ...
            <div className="space-y-3 md:space-y-4 border-l-[3px] md:border-l-[4px] border-black pl-4 md:pl-6">
              <p className="text-base sm:text-lg md:text-xl font-black leading-tight uppercase tracking-tighter">
                Building distributed systems and high-performance applications.
              </p>
              <p className="text-sm md:text-lg text-black/70 leading-relaxed max-w-2xl font-medium">
                I am a backend developer building distributed systems, automation infrastructure, and high-performance applications using Node.js, Next.js, and real-time data workflows.
              </p>
            </div>
          </div>
        </header>
          ...
          <aside className="lg:col-span-5 space-y-10 md:space-y-12">
            ...
            <div className="pt-6 md:pt-8 border-t-[3px] md:border-t-4 border-black">
              ...
              <p className="text-black/70 font-black uppercase text-[10px] md:text-xs leading-loose tracking-tight">
                AIML student @ Bannari Amman Institute of Technology <br />
                Focused on building distributed systems and high-performance applications.
              </p>
            </div>

            <div className="pt-6 md:pt-8 border-t-[3px] md:border-t-4 border-black">
              <h2 className="font-bebas text-2xl md:text-3xl mb-3 md:mb-4 italic">CORE LANGUAGES</h2>
              <div className="flex flex-wrap gap-2 md:gap-3">
                {["Python", "Java", "C++", "JavaScript", "SQL"].map((lang) => (
                  <span
                    key={lang}
                    className="px-3 md:px-4 py-1 md:py-1.5 border-2 border-black font-black uppercase text-[9px] md:text-[10px] tracking-widest cursor-crosshair hover:bg-black hover:text-white transition-colors"
                  >
                    {lang}
                  </span>
                ))}
